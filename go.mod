module github.com/D-PlatformOperatingSystem/plugin

go 1.12

replace github.com/D-PlatformOperatingSystem/dpos => ../dpos

require (
	github.com/BurntSushi/toml v0.3.1
	github.com/D-PlatformOperatingSystem/dpos v1.65.1-0.20201111090506-e2d7705ea453
