...
import (
	...
	pty "github.com/D-PlatformOperatingSystem/plugin/plugin/dapp/collateralize/types"
	issuanceE "github.com/D-PlatformOperatingSystem/plugin/plugin/dapp/issuance/types"
	tokenE "github.com/D-PlatformOperatingSystem/plugin/plugin/dapp/token/executor"
)
...
func getDposNumToFrozen(value int64, price int64, ratio int64) (int64, error) {
	if price == 0 {
		clog.Error("DOM price should greate to 0")
