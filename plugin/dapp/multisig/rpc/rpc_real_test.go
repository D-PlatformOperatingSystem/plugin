...
func TestMultiSigAccount(t *testing.T) {
	...
	//modify dailylimit coins:DOM  1200000000
...
func testAccCreateTx(t *testing.T, mocker *testnode.DplatformOSMock, jrpcClient *jsonclient.JSONClient) string {
	...
	req3 := mty.ReqMultiSigAccInfo{
		MultiSigAccAddr: "16ERTbYtKKQ64wMthAY9J4La4nAiidG45A",
	}
	params.Execer = mty.MultiSigX
...
//testModifyDailyLimit modify dailylimit coins:DOM  1200000000
...
func testConfirmTx(t *testing.T, mocker *testnode.DplatformOSMock, jrpcClient *jsonclient.JSONClient, multiSigAccAddr string) {
	...
	//  account info coins:DOM  SpentToday=100000000
	//t.Log("MultiSigAccountInfo ")
