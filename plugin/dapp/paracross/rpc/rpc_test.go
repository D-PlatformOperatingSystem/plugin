...
import (
	...
	ptestNode "github.com/D-PlatformOperatingSystem/plugin/plugin/dapp/paracross/testnode"
...
//	cfg.Store.Name="mavl"
//	mockDOM := testnode.NewWithConfig(cfg, sub, api)
//	defer func() {
//		mockDOM.Close()
//		mock.AssertExpectationsForObjects(t, api)
//	}()
//	g := newGrpc(api)
//	g.Init(pt.GetExecName(), mockDOM.GetRPC(), newJrpc(api), g)
