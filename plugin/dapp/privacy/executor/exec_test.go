...
func TestPrivacy_CheckTx(t *testing.T) {
	...
	mock.stateDB.Set(calcPrivacyKeyImageKey("coins", "DOM", testKeyImage), []byte("testval"))
	tcArr := []*testcase{
		{
			index:          1,
		...
		{
			index:   2,
			payload: &pty.Public2Privacy{Tokenname: "DOM"},
		},
		{
			index:          4,
			payload:        &pty.Privacy2Public{Tokenname: "DOM", Input: &pty.PrivacyInput{Keyinput: []*pty.KeyInput{}}},
			expectCheckErr: pty.ErrNilUtxoInput,
		},
		{
			index:          5,
			payload:        &pty.Privacy2Privacy{Tokenname: "DOM", Input: &pty.PrivacyInput{Keyinput: []*pty.KeyInput{{}}}},
		...
		{
			index:          7,
			payload:        &pty.Privacy2Public{Tokenname: "DOM", Input: &pty.PrivacyInput{Keyinput: []*pty.KeyInput{{KeyImage: testKeyImage}}}},
		...
		{
			index:          8,
			payload:        &pty.Privacy2Public{Tokenname: "DOM", Input: &pty.PrivacyInput{Keyinput: []*pty.KeyInput{{UtxoGlobalIndex: []*pty.UTXOGlobalIndex{{}}}}}},
