...
import (
	...
	pt "github.com/D-PlatformOperatingSystem/plugin/plugin/dapp/privacy/types"
...
func testStore_unsetUTXO(t *testing.T) {
	...
	addr = "16ctbivFSGPosEWKRwxhSUt6gg9zhPu3jQ"
	txhash = "TXHASH"
	err = store.unsetUTXO("coins", "DOM", addr, txhash, 0, batch)
...
func testStore_listFrozenUTXOs(t *testing.T) {
	...
	assert.Nil(t, txs)
	assert.Nil(t, err)
	tx := &pt.FTXOsSTXOsInOneTx{Tokenname: "DOM"}
