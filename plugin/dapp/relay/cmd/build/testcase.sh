...
function relay_test() {
    ...
    hash=$(${1} send coins transfer -a 1200 -t "$sell_addr" -n "transfer to sell" -k 12oupcayRT7LvaC4qW4avxsTE7U41cKSio)
    echo "${hash}"
    hash=$(${1} send coins transfer -a 600 -t "$acct_addr" -n "transfer to sell" -k 12oupcayRT7LvaC4qW4avxsTE7U41cKSio)
    echo "${hash}"
    hash=$(${1} send coins transfer -a 200 -t "$buy_addr" -n "transfer to buy" -k 12oupcayRT7LvaC4qW4avxsTE7U41cKSio)
    echo "${hash}"
