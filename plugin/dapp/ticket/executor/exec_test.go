...
import (
	...
	executor "github.com/D-PlatformOperatingSystem/plugin/plugin/dapp/ticket/executor"
	pty "github.com/D-PlatformOperatingSystem/plugin/plugin/dapp/ticket/types"
)
...
func Test_Exec_Bind_Unbind(t *testing.T) {
	dplatformosTestCfg := mockDOM.GetAPI().GetConfig()
	env := execEnv{
		1539918074,
		10000,
		2,
