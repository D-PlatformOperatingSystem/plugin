...
func TestBuyMinerAddrTicketOne(t *testing.T) {
	...
	tlist := &types.ReplyStrings{Datas: []string{"12oupcayRT7LvaC4qW4avxsTE7U41cKSio"}}
...
func (_m *walletOperateMock) GetBalance(addr string, execer string) (*types.Account, error) {
	...
	return &types.Account{Balance: 10000000000000, Addr: "12oupcayRT7LvaC4qW4avxsTE7U41cKSio"}, nil
}
